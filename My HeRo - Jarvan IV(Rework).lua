...
function MyHeRoJarvan:QtoE(FromPos, TooPos, PlaceRange, CheckRange)
    ...
    if GetDistance(self.NextSpot) < CheckRange and myHero:CanUseSpell(_E) == READY then
        ...
        if self.Menu.Combo.ComboR and not self.UltActive then
        	self:CastR()
        return "casted"
    else
      	return nil
